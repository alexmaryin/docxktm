...
publishing {
    ...
    publications.withType<MavenPublication> {
        ...
        pom {
            name.set("DocxKtm library")
            description.set("Docx templates populating from Kotlin")
            url.set("https://github.com/alexmaryin/docxktm")
            ...
            scm {
                url.set("https://github.com/alexmaryin/docxktm.git")
            }
        }
    }
}
